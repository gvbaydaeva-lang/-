...
/**
 * Каждый раунд: `emoji` — короткая цепочка по словам / образам названия;
...
const rounds = [
  {
    emoji: "⚪🌹💃🪩",
    answers: ["белые розы"],
    note: "Белое → розы → дискотека.",
  },
  {
    emoji: "🎨🧠💙",
    answers: ["цвет настроения синий"],
    note: "Цвет → настроение → синий.",
  },
  {
    emoji: "⛪📻⛓️",
    answers: ["владимирский централ"],
    note: "Город/собор → «централ» (радио) → зона.",
  },
  {
    emoji: "🥃🍶🪑",
    answers: ["рюмка водки на столе"],
    note: "Рюмка → водка → стол.",
  },
  {
    emoji: "👑⭐1️⃣",
    answers: ["самая самая"],
    note: "«Самая» — топ, звезда, первое место.",
  },
  {
    emoji: "🌲👶🎄",
    answers: ["в лесу родилась елочка", "в лесу родилась елка"],
    note: "Лес → родилась → ёлочка.",
  },
  {
    emoji: "💚👁️🚕",
    answers: ["зеленоглазое такси"],
    note: "Зелёные глаза → такси.",
  },
  {
    emoji: "🌅☀️🎸",
    answers: ["на заре"],
    note: "Заря → день; гитара — знакомая версия хита.",
  },
  {
    emoji: "👥🩸🪖",
    answers: ["группа крови"],
    note: "Группа → кровь → песня про войну.",
  },
  {
    emoji: "🏙️💧🙅‍♀️",
    answers: ["москва слезам не верит"],
    note: "Москва → слёзы → «не верит».",
  },
];
